...
The **Survey lens** (2 crystal, 2 ore) is the answer to "where's the ore I haven't taken yet": the pack gains a Survey list counting how much of each material is still standing, tapping **Track** puts an arrow on the nearest deposit **you've already charted**, and the sky chart marks every unstripped deposit by colour. It only ever points at ground you've been to — remembering is its job, not exploring.
